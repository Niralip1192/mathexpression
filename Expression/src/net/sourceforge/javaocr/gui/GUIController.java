...
public class GUIController
{
    ...
    public String processHandwriting(File sourceImage, File targetImage, MyClass form) throws Exception
    {
        //Make temp directory
        File tempDir = new File("E:/temp");
        System.out.println("creating temp dir:"+tempDir.getAbsolutePath());
        if (!tempDir.mkdir())
        {
            removeAllFiles(tempDir.listFiles());
        }
